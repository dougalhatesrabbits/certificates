...
if __name__ == '__main__':
    ...
    create_selfSignedCert_noenc.generate_private_key(selfKey)
    create_selfSignedCert_noenc.generate_csr(selfKey, selfCSR, self_opensslConf)
    create_selfSignedCert_noenc.generate_x509_cert(selfCSR, selfKey, selfCertificate)
    ...
    create_ECC_CA_Cert.generate_cert(caKey, caCertificate, serverCSR, serverCert, server_opensslConf)
    # ---Client---
    ...
    create_ECC_CA_Cert.generate_cert(caKey, caCertificate, clientCSR, clientCert, client_opensslConf)
